...
- **მონაცემთა მომზადება:**
  ...
  - შექმნილია ახალი თვისებები:
    ...
    - Lag ცვლადები: 4-კვირიანი და 52-კვირიანი წინა გაყიდვები
...
## მოდელი: Random Forest + MLflow

### მიზანი

შემუშავებულია **Random Forest Regressor** დაფუძნებული მოდელი Walmart-ის გაყიდვების პროგნოზირებისთვის. გამოყენებულია MLflow ექსპერიმენტების ლოგირებისა და შედეგების რეპროდუცირებადობისთვის.
...
- პროგნოზი ხორციელდება მომდევნო **5 კვირის განმავლობაში**.
- თითოეული `(Store, Dept)` წყვილზე შეირჩა ბოლო გაყიდვების საშუალო და მედიანური მნიშვნელობები როგორც ლაგ features საწყისი მონაცემი.
- პროგნოზის შედეგები ინახება და აიტვირთება MLflow არტიფაქტად.
